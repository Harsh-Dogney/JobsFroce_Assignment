...
const Hero = () => {
  ...
  const marqueeText = "DIGITAL PRODUCTS • WEB DESIGN • MOBILE APPS • BRANDING • UI/UX • ";
  const repeatedMarquee = marqueeText.repeat(3);
    ...
    <section ref={ref} className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden pt-20 pb-10">
      ...
      >
        <div className="marquee">
          <div className="marquee-content text-4xl font-bold text-foreground/30">
            {repeatedMarquee}
          </div>
        </div>
      </motion.div>
